...
exports.default = (function (apiUrl, httpClient) {
    ...
    return ({
        getList: function (resource, params) {
            ...
            var query = __assign(__assign({}, ra_core_1.fetchUtils.flattenObject(params.filter)), { _sort: field, _order: order, _start: page != null && perPage != null
                    ? (page - 1) * perPage
                    : undefined, _end: page != null && perPage != null ? page * perPage : undefined });
