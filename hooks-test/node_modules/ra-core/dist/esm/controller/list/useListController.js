...
export var useListController = function (props) {
    ...
    var _h = useGetList(resource, {
        ...
        } }, otherQueryOptions)), data = _h.data, pageInfo = _h.pageInfo, total = _h.total, error = _h.error, isLoading = _h.isLoading, isFetching = _h.isFetching, isPending = _h.isPending, refetch = _h.refetch;
