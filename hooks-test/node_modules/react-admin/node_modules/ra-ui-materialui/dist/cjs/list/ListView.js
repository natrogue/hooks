...
var ListView = function (props) {
    ...
    var _e = (0, ra_core_1.useListContext)(), defaultTitle = _e.defaultTitle, data = _e.data, error = _e.error, isPending = _e.isPending, filterValues = _e.filterValues, resource = _e.resource;
    ...
    var shouldRenderEmptyPage = !isPending &&
