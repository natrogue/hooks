...
var AutocompleteInput = function (props) {
    ...
    var _l = (0, ra_core_1.useInput)(__assign({ defaultValue: defaultValue, id: idOverride, field: fieldOverride, fieldState: fieldStateOverride, formState: formStateOverride, isRequired: isRequiredOverride, onBlur: onBlur, onChange: onChange, parse: parse, format: format, resource: resource, source: source, validate: validate, disabled: disabled, readOnly: readOnly }, rest)), id = _l.id, field = _l.field, isRequired = _l.isRequired, _m = _l.fieldState, error = _m.error, invalid = _m.invalid;
    ...
    var handleAutocompleteChange = (0, react_1.useCallback)(function (event, newValue, _reason) {
